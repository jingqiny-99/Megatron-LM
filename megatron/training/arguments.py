...
def _add_inference_args(parser):
    ...
    group.add_argument(
        ...
        'Valid values are "attn", "mlp", "moe", "moe_router", "moe_preprocess", '
        '"mamba", and "mhc_mlp_post": '
        ...
        '"mhc_mlp_post": captures the mHC MoE post-MLP fused H_res/H_post/BDA core '
        'as an auxiliary graph. Must be used together with "moe_router". '
