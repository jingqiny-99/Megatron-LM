...
def _add_experimental_attention_variant_args(parser):
    ...
    group.add_argument('--experimental-attention-variant', default=None, choices=['gated_delta_net'], type=str,
                       help='Type of attention variant to use. Currently support gated_delta_net.')
